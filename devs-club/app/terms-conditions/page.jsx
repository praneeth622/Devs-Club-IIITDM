          ...
          <div className="max-w-4xl mx-auto px-4">
              <div className="p-6 md:p-8">
                ...
                <div className="border-b border-gray-200 pb-6 mb-6">
                  ...
                  <p className="text-gray-600">Last updated: January 06, 2025</p>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Disputes Resolution</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">For European Union (EU) Users</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">United States Legal Compliance</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Translation Interpretation</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Changes to These Terms and Conditions</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700">
                  ...
                  {/* Contact Section */}
                  <section>
                <h2 className="text-3xl font-semibold text-gray-800 mb-6 mt-12">Contact Us</h2>
