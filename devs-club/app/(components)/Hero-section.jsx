      ...
      <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <Link 
              href="/achievements" 
              className="group relative inline-flex items-center bg-blue-600 text-white px-8 py-4 rounded-full overflow-hidden transition-all duration-300 ease-out hover:bg-blue-700 w-full md:w-auto justify-center"
            >
            ...
            <Link 
              href="/about" 
              className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 w-full md:w-auto bg-transparent border-2 border-blue-400 rounded-full hover:border-purple-400 text-white transition-colors duration-300"
            >
