...
export const JoinCommunity = () => {
  return (
    <section className="bg-blue-50 py-20 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
          className="text-4xl font-bold text-gray-800 mb-6 dark:text-white/80"
        >
        ...
        <motion.p
          ...
          className="text-xl text-gray-600 dark:text-white/30 mb-8 max-w-3xl mx-auto"
        >
